...
const calculateBill = () => {
  ...
  let tipPercent = Number(document.getElementById("tipInput").value) / 100;
  ...
  let perPerson =
    totalBill /
    Number(document.getElementById("numberOfPeople").innerHTML).toFixed(2);
  console.log(perPerson);

  // update the perPersonTotal on DOM & show it to user
  document.getElementById("perPersonTotal").innerText = perPerson;
};
